		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="咨询师姓名" prop="name_of_consultant">
												<el-input id="name_of_consultant" v-model="form_sub['name_of_consultant']" placeholder="请输入咨询师姓名"
							  v-if="user_group === '管理员' || (form_sub['consultant_id'] && $check_field('set','name_of_consultant')) || (!form_sub['consultant_id'] && $check_field('add','name_of_consultant'))"></el-input>
					<div v-else-if="$check_field('get','name_of_consultant')">{{form_sub['name_of_consultant']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="咨询师性别" prop="gender_of_consultant">
								<el-select id="gender_of_consultant" v-model="form_sub['gender_of_consultant']"
						v-if="user_group === '管理员' || (form_sub['consultant_id'] && $check_field('set','gender_of_consultant')) || (!form_sub['consultant_id'] && $check_field('add','gender_of_consultant'))">
						<el-option v-for="o in list_gender_of_consultant" :key="o" :label="o" :value="o">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','gender_of_consultant')">{{form_sub['gender_of_consultant']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','license_no') || $check_field('add','license_no') || $check_field('set','license_no')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="执照编号" prop="license_no">
												<el-input id="license_no" v-model="form_sub['license_no']" placeholder="请输入执照编号"
							  v-if="user_group === '管理员' || (form_sub['consultant_id'] && $check_field('set','license_no')) || (!form_sub['consultant_id'] && $check_field('add','license_no'))"></el-input>
					<div v-else-if="$check_field('get','license_no')">{{form_sub['license_no']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="身份证号" prop="id_number">
							  ...
							  v-if="user_group === '管理员' || (form_sub['consultant_id'] && $check_field('set','id_number')) || (!form_sub['consultant_id'] && $check_field('add','id_number'))"></el-input>
