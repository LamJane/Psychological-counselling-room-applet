	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="用户信息" prop="user_information">
							...
							<!--v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','user_information')) || (!form['appointment_information_id'] && $check_field('add','user_information'))" :disabled="disabledObj['user_information_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','user_information')">{{form['user_information']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','user_information')) || (!form['appointment_information_id'] && $check_field('add','user_information'))" id="user_information" v-model="form['user_information']" :disabled="disabledObj['user_information_isDisabled']">
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','user_name')) || (!form['appointment_information_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>
				...
				<el-form-item label="用户年龄" prop="user_age">
							  ...
							  v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','user_age')) || (!form['appointment_information_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']"></el-input>
				...
				<el-form-item label="咨询师信息" prop="consultant_information">
													<el-select v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','consultant_information')) || (!form['appointment_information_id'] && $check_field('add','consultant_information'))" id="consultant_information" v-model="form['consultant_information']" :disabled="disabledObj['consultant_information_isDisabled']">
				...
				<el-form-item label="咨询师姓名" prop="name_of_consultant">
							  ...
							  v-if="user_group === '管理员' || (form['appointment_information_id'] && $check_field('set','name_of_consultant')) || (!form['appointment_information_id'] && $check_field('add','name_of_consultant'))" :disabled="disabledObj['name_of_consultant_isDisabled']"></el-input>
