<template>
	<el-main class="bg table_wrap">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/appointment_information/table','set') || $check_action('/appointment_information/view','set') || $check_action('/appointment_information/view','get') || $check_action('/预约取消|投诉反馈/table','add') || $check_action('/预约取消|投诉反馈/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/appointment_information/table','set') || $check_action('/appointment_information/view','set') || $check_action('/appointment_information/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/appointment_cancellation/view')" v-if="user_group == '管理员' || $check_action('/appointment_cancellation/table','add') || $check_action('/appointment_cancellation/view','add')">
						<span>预约取消</span>
					</el-button>
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/complaint_information/view')" v-if="user_group == '管理员' || $check_action('/complaint_information/table','add') || $check_action('/complaint_information/view','add')">
						<span>投诉反馈</span>
					</el-button>
							</template>
			</el-table-column>
