<template>
  <view class="page_complaint_information diy_table diy_table_tml" id="complaint_information_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/complaint_information/view?" v-show="user_group == '管理员' || $check_action('/complaint_information/table','add') || $check_action('/complaint_information/view','add')">添加</navigator>
                            ...
                            <span>预约时间</span>
								...
								<text>
									{{ $toTime(o["time_of_appointment"],"yyyy-MM-dd hh:mm:ss") }}
													...
													<view v-if="0 && $check_field('get','reasons_for_complaint')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>投诉原因</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/complaint_information/table','del') || $check_action('/complaint_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/complaint_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/complaint_information/table','set') || $check_action('/complaint_information/view','set') || $check_action('/complaint_information/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
