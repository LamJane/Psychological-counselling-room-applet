<template>
  <view class="page_appointment_cancellation diy_table diy_table_tml" id="appointment_cancellation_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/appointment_cancellation/view?" v-show="user_group == '管理员' || $check_action('/appointment_cancellation/table','add') || $check_action('/appointment_cancellation/view','add')">添加</navigator>
                            ...
                            <span>预约时间</span>
								...
								<text>
									{{ $toTime(o["time_of_appointment"],"yyyy-MM-dd hh:mm:ss") }}
													...
													<view v-if="0 && $check_field('get','reason_for_cancellation')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>取消原因</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/appointment_cancellation/table','del') || $check_action('/appointment_cancellation/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/appointment_cancellation/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/appointment_cancellation/table','set') || $check_action('/appointment_cancellation/view','set') || $check_action('/appointment_cancellation/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
