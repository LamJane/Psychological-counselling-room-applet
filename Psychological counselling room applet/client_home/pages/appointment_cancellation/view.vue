          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','user_information') || $check_field('add','user_information') || $check_field('set','user_information')" label="用户信息" name="user_information">
                  ...
                  v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','user_information')) || (!form['appointment_cancellation_id'] && $check_field('add','user_information'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_information']"
                  :localdata="list_user_user_information"
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" label="用户姓名" name="user_name">
                                <uni-easyinput type="text" v-model="form['user_name']" v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','user_name')) || (!form['appointment_cancellation_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_age') || $check_field('add','user_age') || $check_field('set','user_age')" label="用户年龄" name="user_age">
                                <uni-easyinput type="text" v-model="form['user_age']" v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','user_age')) || (!form['appointment_cancellation_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','consultant_information') || $check_field('add','consultant_information') || $check_field('set','consultant_information')" label="咨询师信息" name="consultant_information">
                  ...
                  v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','consultant_information')) || (!form['appointment_cancellation_id'] && $check_field('add','consultant_information'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['consultant_information']"
                  :localdata="list_user_consultant_information"
              ...
              <uni-forms-item v-if="$check_field('get','name_of_consultant') || $check_field('add','name_of_consultant') || $check_field('set','name_of_consultant')" label="咨询师姓名" name="name_of_consultant">
                                <uni-easyinput type="text" v-model="form['name_of_consultant']" v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','name_of_consultant')) || (!form['appointment_cancellation_id'] && $check_field('add','name_of_consultant'))" :disabled="disabledObj['name_of_consultant_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','reason_for_cancellation') || $check_field('add','reason_for_cancellation') || $check_field('set','reason_for_cancellation')" label="取消原因" name="reason_for_cancellation">
                        <uni-easyinput type="textarea" v-model="form['reason_for_cancellation']" v-if="user_group === '管理员' || (form['appointment_cancellation_id'] && $check_field('set','reason_for_cancellation')) || (!form['appointment_cancellation_id'] && $check_field('add','reason_for_cancellation'))" :disabled="disabledObj['reason_for_cancellation_isDisabled']" />
                <!-- 仅查看 -->
