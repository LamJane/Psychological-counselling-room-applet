<template>
  <view class="page_appointment_information diy_table diy_table_tml" id="appointment_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    ...
                    <uni-forms-item label="预约时间" name="time_of_appointment">
                      <uni-easyinput type="text" v-model="query.time_of_appointment" placeholder="预约时间" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/appointment_information/view?" v-show="user_group == '管理员' || $check_action('/appointment_information/table','add') || $check_action('/appointment_information/view','add')">添加</navigator>
                            ...
                            <span>用户年龄</span>
								...
								<text>
									{{ o["user_age"] }}
													...
													<view v-if="0 && $check_field('get','consultant_information')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>咨询师信息</span>
                          </view>
								...
								<text>
									{{ get_user_consultant_information(o['consultant_information']) }}
													...
													<view v-if="0 && $check_field('get','name_of_consultant')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>咨询师姓名</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/appointment_information/table','del') || $check_action('/appointment_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/appointment_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/appointment_information/table','set') || $check_action('/appointment_information/view','set') || $check_action('/appointment_information/view','get')" class="btn btn-primary">详情</navigator>
	                                <!--跨表按钮-->
                                <a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/appointment_cancellation/view','add')" @click="to_form('/pages/appointment_cancellation/view',o)">
                      <span>预约取消</span>
                    </a>
                                <a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/complaint_information/view','add')" @click="to_form('/pages/complaint_information/view',o)">
                      <span>投诉反馈</span>
                    </a>
                        					</view>
				</view>
