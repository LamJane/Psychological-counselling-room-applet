						...
						<view class="">
							<view  class="list_module">
									...
									<navigator class="my_module" url="/pages/system_user/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/consultant/table','get')">
									<navigator class="my_module" url="/pages/consultant/table" hover-class="hover">
										<div>
											<text>咨询师</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/psychological_counseling/table','get')">
									<navigator class="my_module" url="/pages/psychological_counseling/table" hover-class="hover">
										<div>
											<text>心理咨询</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/appointment_information/table','get')">
									<navigator class="my_module" url="/pages/appointment_information/table" hover-class="hover">
										<div>
											<text>预约信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/appointment_cancellation/table','get')">
									<navigator class="my_module" url="/pages/appointment_cancellation/table" hover-class="hover">
										<div>
											<text>预约取消</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/complaint_information/table','get')">
									<navigator class="my_module" url="/pages/complaint_information/table" hover-class="hover">
										<div>
											<text>投诉信息</text>
											<span>></span>
										</div>
