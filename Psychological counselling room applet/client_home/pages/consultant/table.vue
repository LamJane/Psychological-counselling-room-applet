<template>
  <view class="page_consultant diy_table diy_table_tml" id="consultant_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/consultant/view?" v-show="user_group == '管理员' || $check_action('/consultant/table','add') || $check_action('/consultant/view','add')">添加</navigator>
                            ...
                            <span>咨询师姓名</span>
								...
								<text>
									{{ o["name_of_consultant"] }}
													...
													<view v-if="0 && $check_field('get','gender_of_consultant')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>咨询师性别</span>
                          </view>
								...
								<text>
									{{ o["gender_of_consultant"] }}
													...
													<view v-if="0 && $check_field('get','license_no')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>执照编号</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/consultant/table','del') || $check_action('/consultant/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/consultant/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/consultant/table','set') || $check_action('/consultant/view','set') || $check_action('/consultant/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
