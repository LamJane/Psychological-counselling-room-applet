          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','name_of_consultant') || $check_field('add','name_of_consultant') || $check_field('set','name_of_consultant')" label="咨询师姓名" name="name_of_consultant">
                                <uni-easyinput type="text" v-model="form['name_of_consultant']" v-if="user_group === '管理员' || (form['consultant_id'] && $check_field('set','name_of_consultant')) || (!form['consultant_id'] && $check_field('add','name_of_consultant'))" :disabled="disabledObj['name_of_consultant_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','gender_of_consultant') || $check_field('add','gender_of_consultant') || $check_field('set','gender_of_consultant')" label="咨询师性别" name="gender_of_consultant">
                  ...
                  v-if="user_group === '管理员' || (form['consultant_id'] && $check_field('set','gender_of_consultant')) || (!form['consultant_id'] && $check_field('add','gender_of_consultant'))"
                ></uni-data-select>
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','license_no') || $check_field('add','license_no') || $check_field('set','license_no')" label="执照编号" name="license_no">
                                <uni-easyinput type="text" v-model="form['license_no']" v-if="user_group === '管理员' || (form['consultant_id'] && $check_field('set','license_no')) || (!form['consultant_id'] && $check_field('add','license_no'))" :disabled="disabledObj['license_no_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','license_no')">
                  {{ form['license_no'] }}
                </text>
                            </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','id_number') || $check_field('add','id_number') || $check_field('set','id_number')" label="身份证号" name="id_number">
                                <uni-easyinput type="text" v-model="form['id_number']" v-if="user_group === '管理员' || (form['consultant_id'] && $check_field('set','id_number')) || (!form['consultant_id'] && $check_field('add','id_number'))" :disabled="disabledObj['id_number_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      is_password: true,
      field: "consultant_id",
      url_add: "~/api/consultant/add?",
      url_set: "~/api/consultant/set?",
      url_get_obj: "~/api/consultant/get_obj?",
