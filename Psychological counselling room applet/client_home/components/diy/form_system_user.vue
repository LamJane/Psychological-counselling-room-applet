<template>
	<div>
			...
			<view class="diy_title">
				...
				<view v-if="$check_register_field('add','user_gender','/system_user/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					用户性别:
				</text>
			...
			<view class="diy_field diy_down">
				...
				<view v-if="$check_register_field('add','user_age','/system_user/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					用户年龄:
				</text>
