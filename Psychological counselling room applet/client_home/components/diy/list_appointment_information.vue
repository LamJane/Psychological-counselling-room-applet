	...
	<view class="list_appointment_information list_com--new" style="background-color: #fff;">
		...
		<view class="appointment_information_block box_wrap" >
			<navigator class="item_appointment_information box_style" v-for="(o, i) in list"  :key="i" :url="'/pages/appointment_information/details?appointment_information_id=' + o['appointment_information_id']">
					<view class="view" v-if="0 && $check_index_field('get','user_information','/appointment_information/list')">
					<view class="title" v-if="true">
						...
						<view class="view" v-if="1 && $check_index_field('get','user_name','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>用户姓名</span>
					</view>
						...
						<view class="view" v-if="1 && $check_index_field('get','user_gender','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>用户性别</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','user_age','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>用户年龄</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','consultant_information','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>咨询师信息</span>
					</view>
							<view class="diy_field time" >
						...
						<view class="view" v-if="0 && $check_index_field('get','name_of_consultant','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>咨询师姓名</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="1 && $check_index_field('get','time_of_appointment','/appointment_information/list')">
					<view class="title" v-if="true">
						<span>预约时间</span>
					</view>
							<view class="diy_field time" >
