<template>
	<view class="diy_details diy_div_appointment_cancellation">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/appointment_cancellation/get_obj", {
					appointment_cancellation_id:this.query.appointment_cancellation_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["appointment_cancellation_id"] !==0) {
...
<style scoped>
	.div_appointment_cancellation_details {}
